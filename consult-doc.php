...
">
   <div class="container py-5" style="
    ...
    ">
     <div class="card">
       <div class="card-body">
          <h1 class="font-weight-light text-center py-3">Fill The Form For Making Appointment</h1>
          <div class="row">
...
"><i class="fa fa-map-marker" aria-hidden="true" style="margin-bottom: -40;    margin-left: -180;"></i></span>
               ...
               <div class="col-lg-10 col-md-9 col-sm-9 col-9">
                 <h3 class="font-weight-light">Appointment for</h3>
                 <p>
                 <?php
                          ...
                          mysqli_select_db($con,'onlinemed');
                           ...
                           $showname = " SELECT name FROM `consult_doc_ad` ";

                           $showmedi = mysqli_query($con,$showname);

                            $do = mysqli_num_rows($showmedi);


                           // $result = mysqli_fetch_array($showmedi) 
        ...
        mysqli_select_db($con,'onlinemed');
          ...
          if(isset($_POST['submit'])){
           ...
           $q = " INSERT INTO `consult_doc_user`(`name`, `mobile`, `age`, `gender`,`problem`) VALUES ( '$name', '$mobile', '$age' , '$gender','$problem' )";
        ...
        ?>
                ...
                <textarea class="form-control mb-3" placeholder="Write your problems" name="problem" cols="10" rows="5"></textarea>
