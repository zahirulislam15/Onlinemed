                ...
                <div class="row ">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">User Add</h4></div>
                                ...
                                <div class="card-body">
                                    <div class="row">                                           
                                        <div class="col-12">
                                              ...
                                              <div class="row">
                                                    ...
                                                    <div class="col-sm-10">  
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Enter user Phone Number" aria-label="Username" aria-describedby="basic-addon1">
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10">  
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="password" class="form-control" placeholder="Enter user Password" aria-label="Username" aria-describedby="basic-addon1">
                                                        </div>
                                            ...
                                            <label class="custom-control-label checkbox-primary" for="primary">Person</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="checkbox" class="custom-control-input" checked="checked" id="chksecondary">
                                            <label class="custom-control-label checkbox-secondary" for="chksecondary">Organization</label>
                                    </div>
                                                        </div>
