                                ...
                                <div class="card-body h-100 p-0">
                                    <div class="info-card h-100">
                                        ...
                                        <div class="holder-image">
                                            <a href="#"><img src="<?php echo $result['image']?>" alt="" class="img-fluid"> </a>                                       
                                        </div>
                                        <div class="date  text-white" style="font-size: 20px;"><?php echo $result['price']?> BDT</span></div>
                                        <div class="like"><i class="ion ion-heart"></i> Group Name :   <i class="ml-3 ion ion-chatboxes"></i><?php echo $result['groupname']?></div>
                                        <div class="title px-4 text-white mb-3">
                                            

                                            <h5 class="text-white"><?php echo $result['name']?></h5>
