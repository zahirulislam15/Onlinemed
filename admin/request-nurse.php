                    ...
                    <div class="col-12  mt-3">                          
                        <div class="card">
                          ...
                          mysqli_select_db($con,'onlinemed');
                           ...
                           $productshow = " SELECT * FROM `nursing_service` ";
                                        ...
                                        <div class="media d-flex w-100">
                                            ...
                                            <div class="media-body align-self-center pl-2">
                                               <b class="mb-0"><a href="#"><?php echo $result['name']?></a></b><br/>
                                                ...
                                                <p class="mb-0 text-muted">Address: <i class="icofont icofont-briefcase pr-2"></i><?php echo $result['address']?><br>  Purpose: <a href="user-profile.html" class="text-primary"><?php echo $result['purpose']?></a></p>
                                            </div>
                                            ...
                                            <div class="ml-auto mail-tools">
                                                ...
                                                <a href="delete.php?id=<?php echo $result['id'] ?>" data-toggle="tooltip" title="Delete" data-placement="bottom" class="ml-2"><i class="icon-trash"> </i></a>
                                            </div>
                                        </div> 
