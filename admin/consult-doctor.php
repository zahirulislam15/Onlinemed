                    ...
                    <div class="col-12  mt-3">                          
                        <div class="card">
                          ...
                          mysqli_select_db($con,'onlinemed');
                           ...
                           $productshow = " SELECT * FROM `consult_doc_user` ";
                                        ...
                                        <div class="media d-flex w-100">
                                            ...
                                            <div class="media-body align-self-center pl-2">
                                               <b class="mb-0"><a href="#"><?php echo $result['name']?></a></b><br/>
                                                ...
                                                <p class="mb-0 text-muted">age: <i class="icofont icofont-briefcase pr-2"></i><?php echo $result['age']?><br>  gender: <a href="#" class="text-primary"><?php echo $result['gender']?></a></p>
                                                <p class="mb-0 text-muted"><i class="icofont icofont-location-pin pr-2">problems: </i><?php echo $result['problem']?>  </p>
                                            </div>



                                            <div class="ml-auto mail-tools">
                                                <a href="user-profile.html" data-toggle="tooltip" title="View Profile" data-placement="bottom"><i class="icon-eye"></i></a> 
                                                 
                                                <a href="delete-appo.php?id=<?php echo $result['id'] ?>" data-toggle="tooltip" title="Delete" data-placement="bottom" class="ml-2"><i class="icon-trash"> </i></a>
                                            </div>
                                        </div> 
