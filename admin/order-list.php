                ...
                <div class="row">                    
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">User List</h4></div>
                                    ...
                                    <li class="contact  py-3 px-2">
                                        <div class="media d-flex w-100">
                                            ...
                                            <div class="media-body align-self-center pl-2">
                                               <b class="mb-0"><a href="user-profile.html">Jonathan</a></b><br/>
                                                <p class="mb-0 text-muted"><i class="icofont icofont-location-pin pr-2"></i>  San Francisco, California, USA</p>
                                                <p class="mb-0 text-muted"><i class="icofont icofont-briefcase pr-2"></i>  Software Engineer at <a href="user-profile.html" class="text-primary">SomeCompany, Inc.</a></p>
                                            </div>
