...
<head>
    ...
    <body id="main-container" class="default">
       ...
       <div class="sidebar">
                ...
                <div class="row ">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Land List</h4></div>

                            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                                <li class="breadcrumb-item">Home</li>
                                <li class="breadcrumb-item">App</li>
                                <li class="breadcrumb-item active"><a href="#">Land List</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row row-eq-height">
                      ...
                      <?php
                          ...
                          mysqli_select_db($con,'onlinemed');
                           ...
                           $productshow = " SELECT * FROM `prescriptionbox` ";
                     ...
                     <div class="col-12 col-lg-6  col-xl-3 mt-4">
                                ...
                                <div class="card-body h-100 p-0">
                                    <div class="info-card h-100">
                                        ...
                                        <div class="holder-image">
                                            <a href="#"><img src="<?php echo $result['file']?>" alt="" class="img-fluid"> </a>                                       
                                        </div>
                                        
                                        <div class="like"><i class="ion ion-heart"></i> address :   <i class="ml-3 ion ion-chatboxes"></i><?php echo $result['address']?></div>
                                        <div class="title px-4 text-white mb-3">
                                            

                                            <h5 class="text" style="color: black;"><?php echo $result['name']?></h5>
                                            <h5 class="text" style="color: black;"><?php echo $result['mobileno']?></h5>
        ...
        <!-- START: Page JS-->
        <script src="dist/js/task-board.js"></script>
        <!-- END: Page JS-->
