            ...
            <nav class="navbar navbar-expand-lg  p-0">
                <div class="navbar-header h4 mb-0 align-self-center d-flex">  
                    <a href="index.php" class="horizontal-logo align-self-center d-flex d-lg-none">
                        <img src="dist/images/logo.png" alt="logo" width="23" class="img-fluid"/> <span class="h5 align-self-center mb-0 ">OnlinePharma</span>              
                    </a>
                ...
                <div class="row ">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Hospital Add</h4></div>

                            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                                <li class="breadcrumb-item">Home</li>
                                <li class="breadcrumb-item">Page</li>
                                <li class="breadcrumb-item active"><a href="#">Hospital Add</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12  mt-3">                          
                        <div class="card">  
                            <div class="card-header d-flex justify-content-between align-items-center">                               
                                <h4 class="card-title">Hospital Add</h4>                                   
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                move_uploaded_file($filetmp, $destinationfile);
                                                 ...
                                                 $q = " INSERT INTO `hospitalinfo`(`name`, `mobile`, `address`, `image`, `details`) VALUES ( '$name', '$mobile', '$address', '$destinationfile', '$details')";
                                                ...
                                                <div class="row">
                                                    <label for="username" class="col-sm-2 col-form-label">Hospital name</label>
                                                    <div class="col-sm-10">  
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text bg-transparent border-right-0" id="basic-addon11"><i class="icon-user"></i></span>
                                                            </div>
                                                            <input type="text" name="name" class="form-control" placeholder="Enter Hospital Name" aria-label="Username" aria-describedby="basic-addon1">
                                                        </div>
                                              ...
                                              <div class="row">
                                                    ...
                                                    <div class="col-sm-10">  
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="mobile" class="form-control" placeholder="Enter Client Phone Number" aria-label="Username" aria-describedby="basic-addon1">
                                                        </div>

                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <label for="username" class="col-sm-2 col-form-label">Image upload</label>
                                                    <div class="col-sm-10">  
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text bg-transparent border-right-0" id="basic-addon11"><i class="icon-book-open"></i></span>
                                                            </div>
                                                            <input type="file" name="image" class="form-control" placeholder="Upload Hospital Image" aria-label="Username" aria-describedby="basic-addon1">
                                                        </div>
                                               ...
                                               <div class="row">
                                                    ...
                                                    <div class="col-sm-10">  
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="address" class="form-control" placeholder="Enter Client Phone Number" aria-label="Username" aria-describedby="basic-addon1">
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <label for="username" class="col-sm-2 col-form-label">Hospital Details</label>
                                                    <div class="col-sm-10">  
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text bg-transparent border-right-0" id="basic-addon11"><i class="icon-book-open"></i></span>
                                                            </div>
                                                            <textarea style="height: 250px; width:500px;" name="details"></textarea>
                                                        </div>
