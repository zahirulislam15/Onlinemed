                    ...
                    <div class="col-12  mt-3">                          
                        <div class="card">  
                            <div class="card-header d-flex justify-content-between align-items-center">                               
                                <h4 class="card-title">Medicine Add</h4>                                   
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                move_uploaded_file($filetmp, $destinationfile);
                                                 ...
                                                 $q = " INSERT INTO `products`(`name`, `price`, `groupname`, `image`, `details`) VALUES ( '$name', '$price', '$groupname', '$destinationfile', '$details')";
                                                ...
                                                <div class="row">
                                                    <label for="username" class="col-sm-2 col-form-label">Medicine Name</label>
                                                    <div class="col-sm-10">  
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text bg-transparent border-right-0" id="basic-addon11"><i class="icon-user"></i></span>
                                                            </div>
                                                            <input type="text" name="name" class="form-control" placeholder="Medicine Name" aria-label="Username" aria-describedby="basic-addon1">
                                                        </div>
                                              ...
                                              <div class="row">
                                                    ...
                                                    <div class="col-sm-10">  
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="price" class="form-control" placeholder="Medicine price" aria-label="Username" aria-describedby="basic-addon1">
                                                        </div>
                                              ...
                                              <div class="row">
                                                    <label for="username" class="col-sm-2 col-form-label"> Group name</label>
                                                    <div class="col-sm-10">  
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text bg-transparent border-right-0" id="basic-addon11"><i class="icon-book-open"></i></span>
                                                            </div>
                                                            <input type="text" name="groupname" class="form-control" placeholder="Group Name" aria-label="Username" aria-describedby="basic-addon1">
                                                        </div>
