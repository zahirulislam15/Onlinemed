...
">
   <div class="container py-5" style="
    ...
    ">
     <div class="card">
       <div class="card-body">
          <h1 class="font-weight-light text-center py-3">Call a Ambulance</h1>
          <div class="row">
...
"><i class="fa fa-map-marker" aria-hidden="true" style="margin-bottom: -40;    margin-left: -180;"></i></span>
               ...
               <div class="col-lg-10 col-md-9 col-sm-9 col-9">
                 <h3 class="font-weight-light">Call For ambulance</h3>
                 <p>Micle Jordan<br>
                 01768031053<br>
        ...
        mysqli_select_db($con,'onlinemed');
          ...
          if(isset($_POST['submit'])){
           ...
           $mobile = $_POST['mobile'];
           $q = " INSERT INTO `call_ambulance`(`name`, `location`, `picup_time`, `mobile`) VALUES ( '$name', '$location', '$picup_time' , '$mobile' )";
...
?>
              ...
              <form method="post">
                ...
                <input type="Time" placeholder="Address" name="picup_time" class="form-control">
                
                <button class="btn btn-primary float-right" type="submit" name="submit">Book Now</button>
              </form>
            </div>
          </div>
       </div>
